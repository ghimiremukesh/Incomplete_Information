...
p.add_argument('--lr', type=float, default=2e-7, help='learning rate. default=2e-5')
...
model = modules_picnn.SingleBVPNet(in_features=6, out_features=1, type=opt.model, mode=opt.mode,
