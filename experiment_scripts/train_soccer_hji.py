...
dataset = dataio.SoccerIncomplete(numpoints=2000, theta=opt.theta, velocity=0, u_max=0.3, d_max=0.1, tMin=opt.tMin,
...
root_path = os.path.join(opt.logging_root, 'soccer_martingale_test/')
