...
p.add_argument('--counter_end', type=int, default=40000, required=False, help='Defines the linear step for curriculum training starting from the initial time')
...
dataset = dataio.SoccerHJI(numpoints=500, theta=opt.theta, velocity=0, u_max=0.3, d_max=0.1, tMin=opt.tMin,
...
root_path = os.path.join(opt.logging_root, 'soccer_test_maximin/')
