...
dataset = dataio.SoccerIncomplete(numpoints=65000, theta=opt.theta, velocity=0, u_max=0.3, d_max=0.1, tMin=opt.tMin,
...
root_path = os.path.join(opt.logging_root, '4d_tests_full_train/')
