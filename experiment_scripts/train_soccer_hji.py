...
import dataio, utils, training, loss_functions, modules_picnn, modules
...
p.add_argument('--experiment_name', type=str, default='test_for_iros_fast', required=False,
               help='Name of subdirectory in logging_root where summaries and checkpoints will be saved.')

# General training options
p.add_argument('--batch_size', type=int, default=32)
p.add_argument('--lr', type=float, default=2e-5, help='learning rate. default=2e-5') # 1 for lbfgs

# 200000 for hybrid, 100000 for supervised, 160000 for self-supervised
p.add_argument('--num_epochs', type=int, default=40000,
...
dataset = dataio.SoccerIncomplete(numpoints=30000, velocity=0, u_max=1, d_max=0.8, tMin=opt.tMin,
