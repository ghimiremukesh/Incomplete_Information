...
class FCBlock(nn.Module):
    ...
    def forward(self, coords, params=None, **kwargs):
        ...
        y_input = coords[..., -1:]
        u_input = coords[..., :-1]
        z_input = self.net_z_u[0](u_input) + self.net_z_y[0](torch.mul(y_input, self.net_z_yu[0](u_input)))

        z_input = torch.tanh(z_input)
        u_input = self.net_z_u[0](u_input)
